<p align="center">
  <picture>
    <source srcset="static/assets/icons/signstr-logo.png" media="(prefers-color-scheme: dark)" width="300">
    <img alt="Signstr Logo" src="/doc/logo-black.svg" width="300">
  </picture>
</p>

<h1 align="center">Signstr - Nostr Browser Extension</h1>
...
[Refer to SETUP.md for info regarding how to setup Signstr](./doc/SETUP.md)
